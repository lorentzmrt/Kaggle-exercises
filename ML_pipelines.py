...
numerical_transformer = SimpleImputer(strategy='constant') # strategy = median, constant, mean, 

# Preprocessing for categorical data
categorical_transformer = Pipeline(steps=[
    ('imputer', SimpleImputer(strategy = 'most_frequent')), # strategy = constant, most_frequent (string)
...
#   and model training in separate steps.
...
#### Conclusion ####
# Pipelines are valuable for cleaning up machine learning code and avoiding errors, 
